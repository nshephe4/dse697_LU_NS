...
hq_data = load_csv('/gpfs/wolf2/olcf/trn040/scratch/nshephe4/dse697_LU_NS/data/HQ_examples.csv', 'Expected Answer', return_all=True)
hq_expected = [row["Expected Answer"] for row in hq_data]
rag_responses = load_csv('/gpfs/wolf2/olcf/trn040/scratch/nshephe4/dse697_LU_NS/benchmarks/RAG_basemodel.csv', 'Generated Answer')
...
# Write to .csv
with open("RAG_evaluation_results_basemodel.csv", "w", newline="") as file:
